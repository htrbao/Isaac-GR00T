...
class G1VRRightHandOnlyConfig(BaseDataConfig):
...
class G1VRLeftHandOnlyConfig(BaseDataConfig):
    video_keys = ["video.cam_top"]
    state_keys = [
        "state.left_arm",
        "state.left_hand",
...
DATA_CONFIG_MAP = {
    ...
    "g1_vr_right_hand_only": G1VRRightHandOnlyConfig(),
    "g1_vr_left_hand_only": G1VRLeftHandOnlyConfig(),
}
